...
function showUserProfile() {
    ...
    document.getElementById('userProfileContainer').innerHTML =
        `<div class="container-fluid" style="padding: 0;">
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id='userProfileNavbar'>
                <div class="container-fluid">
                    <a class="navbar-brand companyHeading" href="#" style="letter-spacing: 3px;">PUJARI JCB SPARES</a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav">
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" onclick='homeClick()'>Home</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link logoutButton" aria-current="page" onclick='logoutClick()'>Log out</a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="container  userProfileDiv">
                ...
                <div class="m-3">
                    ...
                    <input type="text" class="form-control" id="nameInput" aria-describedby="emailHelp"
                        onkeyup="nameValidate()" value='${parseUserData[0].name}' readonly>
                    <span id="nameError" style="color: red;"></span>
                </div>
                <div class="m-3">
                    <label for="emailIdInput" class="form-label">Email Id</label>
                    <input type="text" class="form-control" id="emailIdInput" aria-describedby="emailHelp"
                        value='${parseUserData[0].email}' readonly>
                </div>
                <div class="m-3">
                    <label for="mobileInput" class="form-label">Mobile Number</label>
                    <input type="text" class="form-control" id="mobileInput" aria-describedby="emailHelp"
                        onkeyup="mobileValidate()" value='${parseUserData[0].mobile}' readonly>
                    <span id="mobileError" style="color: red;"></span>
                </div>
                <div class="m-3">
                    <label for="addressInput" class="form-label">Address</label>
                    <input type="text" class="form-control" id="addressInput" aria-describedby="emailHelp"
                        onkeyup="addressValidate()" value='${parseUserData[0].address}' readonly>
                    <span id="addressError" style="color: red;"></span>
                </div>
                <div class="m-3">
                    <label for="occupationInput" class="form-label">Occupation</label>
                    <input type="text" class="form-control" id="occupationInput" aria-describedby="emailHelp"
                        onkeyup="occupationValidate()" value='${parseUserData[0].occupation}' readonly>
                    <span id="occupationError" style="color: red;"></span>
                </div>
                <div style="text-align:center;justify-content:space-evenly; padding-bottom:10px">
                    <button type="button" class="btn btn-primary" id="submitButton" onclick="submitInfoButtonClick()"
...
function homeClick() {
    // console.log('homeClick invoked');
    document.getElementById('userProfileNavbar').style = 'display: none;'
